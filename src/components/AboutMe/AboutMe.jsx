        ...
        <div className="about-me__container">
            ...
            <div className="about-me__text">
                ...
                <div className="about-me__text-block">
                    ...
                    В свободное время я люблю осваивать новые технологии, экспериментировать с творческим кодингом и создавать интересные веб-проекты.  
                    Также мне нравится играть на гитаре, погружаясь в атмосферу любимых мелодий.  
                    А еще я увлекаюсь настольными играми — они помогают развивать стратегическое мышление и весело проводить время в хорошей компании.
                    Мой верный друг — замечательная собачка, с которой мы вместе открываем для себя мир, наполняя каждый день новыми открытиями и впечатлениями.
                    </p>
                    <p className="text-block__p">
